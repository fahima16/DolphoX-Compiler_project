...
export default function Navbar({ theme, setTheme, language, setLanguage, onRun, toggleSidebar }) {
  ...
  return (
    <header className={`flex flex-col border-b transition-colors duration-300 ${
      ...
      <div className="flex items-center justify-between px-3 md:px-4 py-2">
        ...
        {/* Left Section: Mobile Menu Button + Compact Logo */}
        <div className="flex items-center space-x-3">
          <button 
            onClick={toggleSidebar}
            className="md:hidden p-1.5 rounded bg-slate-800 text-white hover:bg-slate-700"
          >
            <Menu size={18} />
          </button>

          {/* Logo: Dolphin on top, DolphoX text at the bottom */}
          ...
          {/* Desktop Primary Toolbars */}
          <div className="hidden lg:flex items-center space-x-1.5 border-l border-slate-700/50 pl-4">
            <button className="p-1.5 bg-slate-800 hover:bg-slate-700 rounded text-slate-300 shadow" title="New File"><FileText size={15} /></button>
            <button className="p-1.5 bg-slate-800 hover:bg-slate-700 rounded text-slate-300 shadow" title="New Project"><FolderPlus size={15} /></button>
            <button className="p-1.5 bg-slate-800 hover:bg-slate-700 rounded text-slate-300 shadow" title="Save"><Save size={15} /></button>
            ...
            <button className="flex items-center space-x-1 px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded text-xs font-semibold shadow">
              <Bug size={13} /> <span>Debug</span>
            </button>
            <button className="flex items-center space-x-1 px-3 py-1.5 bg-rose-600 hover:bg-rose-500 text-white rounded text-xs font-semibold shadow">
              <Square size={13} /> <span>Stop</span>
            </button>
            <button className="flex items-center space-x-1 px-2.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded text-xs shadow">
        ...
        {/* Right Section: Language Select & Theme Switcher */}
        <div className="flex items-center space-x-3 md:space-x-4">
          ...
          <button className="p-1.5 bg-slate-800 hover:bg-slate-700 rounded text-slate-300 hidden sm:block">
            <Settings size={15} />
          </button>
        </div>
      ...
      <div className={`hidden md:flex items-center px-4 py-1.5 border-t space-x-2 overflow-x-auto ${
        ...
        <div className="flex items-center space-x-1 text-slate-400">
          <button className="p-1 hover:bg-slate-800 hover:text-white rounded transition"><Undo2 size={14} /></button>
          <button className="p-1 hover:bg-slate-800 hover:text-white rounded transition"><Redo2 size={14} /></button>
          <span className="text-slate-700">|</span>
          <button className="p-1 hover:bg-slate-800 hover:text-white rounded transition"><FileText size={14} /></button>
          <button className="p-1 hover:bg-slate-800 hover:text-white rounded transition"><ListTree size={14} /></button>
          <button className="p-1 hover:bg-slate-800 hover:text-white rounded transition"><Maximize2 size={14} /></button>
          <span className="text-slate-700">|</span>
